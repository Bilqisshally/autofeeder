...
const Opening = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-900 via-blue-800 to-blue-700">
      ...
      <main className="ml-0 md:ml-64 min-h-screen flex items-center justify-center px-4 py-8">

        {/* CARD */}
        <div className="w-full max-w-md rounded-3xl bg-white p-10 shadow-2xl mt-8">
